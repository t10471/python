...
import sqlalchemy
from sqlalchemy import Column,TIMESTAMP,Integer,String,Text,Date,Float,ForeignKey
...
class Stock(Base):
    ...
    market_code   = Column('market_code', String, ForeignKey('market.code'))
...
class StockDate(Base):
    ...
    stock_code     = Column('stock_code', Integer, primary_key=True, autoincrement=False, ForeignKey('stock.code'))
...
class AnalysisDate(Base):
    ...
    stock_code   = Column('stock_code', Integer, primary_key=True, autoincrement=False, ForeignKey('stock_date.stock_code'))
    date         = Column('date', Date, primary_key=True, autoincrement=False, ForeignKey('stock_date.date'))
    group_id     = Column('group_id',Integer , primary_key=True, autoincrement=False, ForeignKey('analysis_group.id'))
...
class Analysis(Base):
    ...
    id            = Column('id',Integer , primary_key=True, autoincrement=False) #@ReservedAssignment
    ...
    def __init__(self, id, parent_id, name, display_name):  #@ReservedAssignment
        self.id           = id  #@ReservedAssignment
...
class AnalysisParameter(Base):
    ...
    group_id      = Column('group_id',Integer , primary_key=True, autoincrement=False, ForeignKey('analysis.id'))
    key           = Column('key',Text )
